...
train = pd.read_csv('F:/UPMC_Food_101/texts/train_titles.csv', names=colnames, header=None, sep = ',', index_col=['image_path'])
test = pd.read_csv('F:/UPMC_Food_101/texts/test_titles.csv', names=colnames, header=None, sep = ',', index_col=['image_path'])
